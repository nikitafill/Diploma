...
namespace DiplomaProject.Migrations
{
    ...
    [Migration("20250618191244_add table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiplomaProject.DAL.Models.ExperimentGroupQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("ExperimentGroupId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ExperimentGroupId");

                    b.HasIndex("QuestionId");

                    b.ToTable("ExperimentGroupQuestions");
                });
            ...
            modelBuilder.Entity("DiplomaProject.DAL.Models.ExperimentGroupQuestion", b =>
                {
                    b.HasOne("DiplomaProject.DAL.Models.ExperimentGroup", "ExperimentGroup")
                        .WithMany("ExperimentGroupQuestions")
                        .HasForeignKey("ExperimentGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DiplomaProject.DAL.Models.ExperimentGroup", b =>
                {
                    b.Navigation("ExperimentGroupQuestions");
